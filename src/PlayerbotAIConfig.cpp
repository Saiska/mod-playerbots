...
bool PlayerbotAIConfig::Initialize()
{
    ...
    guildmateAscensor = sConfigMgr->GetOption<bool>("AiPlayerbot.GuildmateAscensor", true);
    ...
    guildBankDepositProactiveEnable = sConfigMgr->GetOption<bool>("AiPlayerbot.GuildBankDeposit.ProactiveEnable", true);
    guildBankDepositKeepStacks = sConfigMgr->GetOption<uint32>("AiPlayerbot.GuildBankDeposit.KeepStacks", 1);
    guildReagentVaultEnable = sConfigMgr->GetOption<bool>("AiPlayerbot.GuildReagentVault.Enable", true);
    guildBankGoldDepositEnable = sConfigMgr->GetOption<bool>("AiPlayerbot.GuildBankGoldDeposit.Enable", true);
    ...
    activityScaleStatistic = sConfigMgr->GetOption<uint32>("AiPlayerbot.ActivityScaleStatistic", 1);
    activityScalePercentile = sConfigMgr->GetOption<uint32>("AiPlayerbot.ActivityScalePercentile", 90);
    ...
    // Proportional sink/convert split: at each currency tier, spend this percent of the tier's balance on
    ...
    casterWeaponComboEval = sConfigMgr->GetOption<bool>("AiPlayerbot.CasterWeaponComboEval", true);
    disposeDisplacedUpgradeGear = sConfigMgr->GetOption<bool>("AiPlayerbot.DisposeDisplacedUpgradeGear", true);
    ...
    pastimeFishDwellMax = sConfigMgr->GetOption<uint32>("AiPlayerbot.Pastime.Fish.DwellMax", 180);
    // urand asserts max >= min; guard against an inverted operator config.
