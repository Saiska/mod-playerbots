...
public:
    ...
    uint32 globalCoolDown, reactDelay, maxWaitForMove, disableMoveSplinePath, maxMovementSearchTime, expireActionTime,
        dispelAuraDuration, passiveDelay, repeatDelay, emoteCooldown, errorDelay, rpgDelay, sitDelay, returnDelay, lootDelay;
    ...
    uint32 raidSimCurrencyExpandFloorOffset; // currency-expansion pool floor below ilvl_cap (0 = no floor)
