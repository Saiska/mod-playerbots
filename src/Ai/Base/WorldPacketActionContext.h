...
public:
    WorldPacketActionContext()
    {
        ...
        creators["lfg teleport recovery"] = &WorldPacketActionContext::lfg_teleport_recovery;
...
private:
    ...
    static Action* lfg_teleport_recovery(PlayerbotAI* botAI) { return new LfgTeleportRecoveryAction(botAI); }
