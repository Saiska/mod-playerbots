...
public:
    TriggerContext()
    {
        ...
        creators["lfg teleport recovery"] = &TriggerContext::lfg_teleport_recovery;
...
private:
    ...
    static Trigger* lfg_teleport_recovery(PlayerbotAI* botAI) { return new LfgTeleportRecoveryTrigger(botAI); }
