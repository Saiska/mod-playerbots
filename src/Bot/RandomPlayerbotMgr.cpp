...
/*    uint32 update = 0;
    ...
    if (sPlayerbotAIConfig.enableNewRpgStrategy)
    {
        ...
        LOG_INFO("playerbots",
                 "    Idle: {}, Rest: {}, GoGrind: {}, GoCamp: {}, MoveRandom: {}, MoveNpc: {}, CityLife: {}, "
                 "DoQuest: {}, TravelFlight: {}, OutdoorPvP: {}",
                 ...
                 rpgStatusCount[RPG_CITY_LIFE], rpgStatusCount[RPG_DO_QUEST], rpgStatusCount[RPG_TRAVEL_FLIGHT],
